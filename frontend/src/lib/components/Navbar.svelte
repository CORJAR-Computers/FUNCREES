<script>
  ...
  function isActive(path) {
    return (/** @type {string} */ (page.url.pathname)) === path;
  }
...
<header class="header">
  <div class="header-container">
    <a href="/" class="logo-wrapper" onclick={closeMenu}>
      <img class="logo-img" src="/assets/Logo.png" alt="Logo Funcrees" style="height: 50px; width: auto; object-fit: contain;">
      <div class="logo-text">
    ...
    <button class="menu-toggle" aria-label="Abrir menú de navegación" onclick={toggleMenu}>
